...
const ChartContext = React.createContext(null) // Removed type annotation
...
const ChartContainer = React.forwardRef(({ id, className, children, config, ...props }, ref) => { // Removed type annotations
...
const ChartStyle = ({ id, config }) => { // Removed type annotations
  const colorConfig = Object.entries(config).filter(
    ([, configItem]) => configItem.theme || configItem.color // Changed variable name to avoid conflict
  )
                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    >
                      ...
                      {item.value != null && ( // Check for null/undefined instead of just truthiness
