...
const BlockSelection = ({ onBlockSelect, selectedBlock }) => { // Removed type annotation
  ...
  useEffect(() => {
    if (gridRef.current) {
        const cards = gridRef.current.querySelectorAll('.block-card');
        ...
        const ctx = gsap.context(() => {
            cards.forEach(card => {
                ...
                card.gsapAnimation = animation; // Removed type assertion
            });
        ...
        return () => {
             ...
             cards.forEach(card => {
                 const animation = card.gsapAnimation; // Removed type assertion
                 if (animation) {
