...
// Removed type import for MenuItem
...
// Removed type annotation for mockMenus
const mockMenus = {
  "fc1a": [
...
const getCategoryIcon = (category) => { // Removed type annotation
...
const Menu = ({ foodCourtId }) => { // Removed type annotation
  ...
  const handleAddToCart = (item) => { // Removed type annotation
